      ...
      <main>
        <article v-for="show in shows" :key="show">
          ...
          <div :id="show.id" class="hero-image">
            <div class="jumbotron jumbotron-fluid">
              <div class="container">
                ...
                <span class="img-cred">Image cred: <a :href="show.img_link">{{ show.img_creds }}</a></span>
              </div>
            </div>
          </div>
          <section class="container">
            ...
            <!-- My Thoughts -->
            <div class="text-center"><button class="btn btn-danger button" @click="show.toggle_my_thoughts = !show.toggle_my_thoughts">{{ show.toggle_my_thoughts ? 'My Thoughts -' : 'My Thoughts +'}}</button></div>
            ...
            <div v-if="show.thoughts_with_spoilers" class="text-center"><button class="btn btn-danger button" @click="show.toggle_my_thoughts_with_spoilers = !show.toggle_my_thoughts_with_spoilers">{{ show.toggle_my_thoughts_with_spoilers ? `My Thoughts (with spoilers) -` : 'My Thoughts (with spoilers) +'}}</button></div>
            ...
            <!-- TV sins -->
            <div v-if="show.fav_episodes" class="text-center"><button class="btn btn-danger button" @click="show.toggle_fav_episodes = !show.toggle_fav_episodes">{{ show.toggle_fav_episodes ? 'Fav Episodes -' : 'Fav Episodes +'}}</button></div>
            ...
            <!-- TV sins -->
            <div v-if="show.tv_sins" class="text-center"><button class="btn btn-danger button" @click="show.toggle_tv_sins = !show.toggle_tv_sins">{{ show.toggle_tv_sins ? 'TV Sins (SPOILERS...duh) -' : 'TV Sins (SPOILERS...duh) +'}}</button></div>
